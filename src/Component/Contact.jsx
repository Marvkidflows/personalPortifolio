...
const ContactPage = () => {
  ...
  const contactMethods = [
    {
      ...
      action: () => window.open('https://wa.me/+2349132416094', '_blank'),
    ...
    },
    {
      ...
      action: () => window.open('mailto:ibigbamimarvellous@gmail.com', '_blank'),
    ...
    },
    {
      ...
      action: () => window.open('https://www.linkedin.com/in/marvellous-nifemi-9401532b4', '_blank'),
  ...
  useEffect(() => {
  emailjs.init('YV6UdNn-w5kcQJ3O9'); // Only public key here
}, []);

const sendMail = (e) => {
  e.preventDefault();
  emailjs.sendForm('service_l217w9g', 'template_xoje8co', form.current, 'YV6UdNn-w5kcQJ3O9')
    .then(() => {
