      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="flex justify-center items-center flex-wrap gap-6 mb-12">
          ...
          >
            ...
            <span className="font-medium">ibigbamimarvellous.email@example.com</span>
          </a>
          
          <a 
            href="https://www.linkedin.com/in/marvellous-nifemi-9401532b4" 
            target="_blank" 
          ...
          <a 
            href="https://github.com/marvkidflows" 
            target="_blank" 
            rel="noopener noreferrer"
            className="flex items-center gap-2 bg-slate-800 hover:bg-slate-700 px-6 py-3 rounded-full transition-all duration-300 hover:scale-105"
          ...
          <a 
            href="https://twitter.com/MarvellousIbig1" 
            target="_blank" 
            rel="noopener noreferrer"
          ...
          <a 
            href="https://instagram.com/nifemiflows_12" 
            target="_blank" 
            rel="noopener noreferrer"
          ...
          <div className="max-w-7xl mx-auto px-6 py-3"> 
            <div className="flex flex-col md:flex-row justify-between items-center gap-2">
              <p className="text-slate-400 mb-6 text-sm">
                © {new Date().getFullYear()} Ibigbami marvellous. All rights reserved.
              </p>
