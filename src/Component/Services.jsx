...
const Services = () => {
  return (
    <section className="min-h-screen bg-gray-950 py-20 px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
       ...
       <h4 className="inline-block px-4 py-1 text-sm font-semibold tracking-wider  
    bg-gradient-to-r from-cyan-500 to-blue-500 text-transparent bg-clip-text   mb-6">
    What I Offer
  </h4>
